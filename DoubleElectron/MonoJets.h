...
// Fri Oct 19 13:17:31 2018 by ROOT version 6.06/01
// from TTree eventTree/event tree for analysis
// found on file: /hdfs/store/user/varuns/NTuples/Data/Run2018_PromptReco/MET/MET2018Av1/0000/Data_MET2018Av1_1.root
//////////////////////////////////////////////////////////
...
public :
   ...
   TH2F *h_eleRecoSF_highpt,*h_eleIDSF_tight, *h_eleIDSF_loose;
   ...
   TH1F *h_j1Pt[nHisto], *h_j1Eta[nHisto], *h_j1Phi[nHisto], *h_j1etaWidth[nHisto], *h_j1phiWidth[nHisto],*h_j1nCons[nHisto];
   TH1F *h_j1CHF[nHisto], *h_j1NHF[nHisto], *h_j1ChMultiplicity[nHisto], *h_j1NeutMultiplicity[nHisto],*h_j1Mt[nHisto];
   ...
   TH2F *h_leadingLeptonEtaPhiComp[nHisto], *h_subleadingLeptonEtaPhiComp[nHisto];
...
// Fixed size dimensions of array or collections stored in the TTree if any.
  ...
  MonoJets(const char* file1,const char* file2,const char* fileRange);
  virtual ~MonoJets();
  ...
  virtual double getSF(int lepindex_leading, int leptindex_subleading);

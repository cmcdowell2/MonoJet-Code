...
public :
   ...
   double dilepton_pt,dilepton_mass,Recoil;
   float leptoMET_phi_to_use;

   int TotalPFCandidates;
   int ChargedPFCandidates;
   int NeutralPFCandidates;
   int GammaPFCandidates;
   ...
   TH2F *h_LeptonEtaPhiComp[nHisto], *h_j1EtaPhiComp[nHisto];

...
vector<string> MonoJets::split(string str,string delim) {
...
bool MonoJets::fileSelection(string filename, string fileRange)
{
...
MonoJets::MonoJets(const char* file1, const char* file2, const char* fileRange)
{
...
Int_t MonoJets::GetEntry(Long64_t entry)
{
// Read contents of entry.
  if (!fChain) return 0;
  return fChain->GetEntry(entry);
}
Long64_t MonoJets::LoadTree(Long64_t entry)
{
...
void MonoJets::Show(Long64_t entry)
{
...
Int_t MonoJets::Cut(Long64_t entry)
{
